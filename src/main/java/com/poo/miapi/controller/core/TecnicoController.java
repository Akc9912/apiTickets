...
public class TecnicoController {
    ...
    public ResponseEntity<String> tomarTicket(@RequestParam Long idTecnico, @PathVariable Long ticketId) {
    ...
    public ResponseEntity<String> finalizarTicket(@RequestParam Long idTecnico, @PathVariable Long ticketId) {
    ...
    public ResponseEntity<String> devolverTicket(@RequestParam Long idTecnico, @PathVariable Long ticketId,
    ...
    public ResponseEntity<List<IncidenteTecnicoResponseDto>> obtenerHistorialIncidentes(@RequestParam Long tecnicoId) {
